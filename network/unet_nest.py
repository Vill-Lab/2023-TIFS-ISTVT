...
class UNet_Nested(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=3, feature_scale=2, is_deconv=True, is_batchnorm=True, is_ds=True):
    ...
    def forward(self, inputs):
        ...
        if self.is_ds:
            return final,[X_01,X_11,X_21,X_31,X_02,X_12,X_22,X_03,X_13,X_04]
        else:
            return final_4
...
if __name__ == '__main__':
    ...
    x = Variable(torch.rand(8,3,299,299)).cuda()
