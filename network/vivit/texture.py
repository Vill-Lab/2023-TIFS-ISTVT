...
class MAT(nn.Module):
    def __init__(self, net='xception',feature_layer='b3',attention_layer='final',num_classes=2, M=100,mid_dims=256,\
    ...
    def forward(self,x,jump_aux=False,drop_final=False):
        layers = self.net(x)
